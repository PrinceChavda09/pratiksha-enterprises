...
export default function ContactFormSection() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    product: "Copper Bonded Chemical Earthing Rods",
    quantity: "",
    message: "",
  });
  ...
  return (
    <section id="contact-form" className="py-16 sm:py-20 lg:py-24 bg-white relative scroll-mt-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-white rounded-xl border border-slate-200 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] focus:border-transparent transition-all"
                    >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] text-white rounded-3xl p-6 sm:p-8 shadow-xl">
              ...
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed mb-6">
                Avoid middleman markups and delayed lead times. We engineer, test, and ship directly from our Rajkot manufacturing facilities with full compliance certificates.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-white">NABL & CPRI Tested Compliance</h4>
                    <p className="text-xs text-slate-400">Manufactured strictly to IS 3043 and IEEE 80 standards.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-white">Direct-From-Plant Pricing</h4>
                    <p className="text-xs text-slate-400">Competitive bulk rates for contractors and infrastructure projects.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-white">Pan-India Freight Logistics</h4>
                    <p className="text-xs text-slate-400">Dependable transit tie-ups ensuring timely site delivery.</p>
                  </div>
                </div>
              </div>
            </div>
