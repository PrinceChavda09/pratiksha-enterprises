      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 flex flex-col justify-between min-h-[380px] sm:min-h-[420px] lg:min-h-[460px] xl:min-h-[490px]">
        ...
        <div className="max-w-xl lg:max-w-2xl py-2 sm:py-4">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[44px] xl:text-[48px] font-black text-[#0f172a] tracking-tight leading-[1.1]">
            ...
            <span className="text-[var(--primary-color)]">A Safer</span> Tomorrow
          </h1>
          ...
          <div className="mt-5 sm:mt-6 pt-4 sm:pt-5 border-t border-slate-200/90 grid grid-cols-3 gap-2 sm:gap-4 max-w-lg">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] sm:text-xs font-bold text-[#0f172a] leading-tight">
                Quick <br className="hidden sm:inline" />Response
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 border-l border-slate-200 pl-2 sm:pl-4">
              ...
              <span className="text-[11px] sm:text-xs font-bold text-[#0f172a] leading-tight">
                Expert <br className="hidden sm:inline" />Support
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 border-l border-slate-200 pl-2 sm:pl-4">
              ...
              <span className="text-[11px] sm:text-xs font-bold text-[#0f172a] leading-tight">
                Trusted <br className="hidden sm:inline" />Partnership
              </span>
            </div>
          </div>
        </div>
