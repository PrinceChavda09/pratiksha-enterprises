  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 pointer-events-none select-none">
        ...
        <div
          className="hidden sm:block absolute pointer-events-auto group top-[52%] sm:top-[53%] lg:top-[53%] xl:top-[54%] -translate-x-1/2 transition-[left] duration-150"
      ...
      <div className="absolute bottom-[28%] sm:bottom-[26%] md:bottom-[30%] lg:bottom-[24%] xl:bottom-[28%] 2xl:bottom-[30%] left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-2 md:right-2 lg:right-3 xl:right-10 2xl:right-14 z-20 pointer-events-auto">
        <div className="relative group">
          ...
          <div className="relative w-[340px] sm:w-[380px] md:w-[430px] lg:w-[540px] xl:w-[720px] 2xl:w-[860px] h-[245px] sm:h-[270px] md:h-[300px] lg:h-[385px] xl:h-[430px] 2xl:h-[470px] transition-transform duration-500 ease-out">
            <Image
      ...
      <div className="relative z-30 h-auto sm:h-auto md:h-auto lg:h-[62%] xl:h-[63.5%] container px-4 sm:px-6 lg:px-8 flex flex-col items-center sm:items-start justify-start lg:justify-end pt-8 sm:pt-10 md:pt-12 lg:pt-0 pointer-events-none">
